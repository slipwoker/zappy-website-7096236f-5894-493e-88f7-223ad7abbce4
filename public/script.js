      ...
      formData.forEach((value, key) => {
        ...
        try {
            ...
            const zappyResponse = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '7096236f-5894-493e-88f7-223ad7abbce4',
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "בשבילך - ייעוץ וליווי בקריירה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
